...
<script type="text/javascript" src="${APP_PATH }/static/js/publish.js"></script>
<script type="text/javascript" src="${APP_PATH }/static/js/wangEditor.js"></script>
<script type="text/javascript">
	$(function(){
			...
			$("#btn1").on("click",function(){
				...
				var musicFile = $('.bs-example-modal-lg input[name=musicFile]')[0].files[0]; //获得文件上传的输入框的文件流
				var videoFile = $('.bs-example-modal-lg input[name=videoFile]')[0].files[0]; //获得文件上传的输入框的文件流
				var titlePage1 = $('.bs-example-modal-lg input[name=titlePage]')[0].files[0]; //获得文件上传的输入框的文件流
				formData.append('type',0);//图文类
				...
				formData.append('titlePage',titlePage1);
				$.ajax({
		    		async:false,
		    		url:"${APP_PATH }/user/userReleaseArticles",
		    		type:'POST',
		    		//不处理参数数据
		    		processData : false,
			...
			$("#btn2").on("click",function(){
				...
				var videoFile = $(".bs-example-modal-video input[name=videoFile]")[0].files[0]; //获得文件上传的输入框的文件流
		...
		$("#btn3").on("click",function(event){
			...
			$.post("${APP_PATH }/user/updateArticleServlet",
					{"articleId":articleId,
		...
		$('.deleteYesDel').click(function(){
          ...
          <div class="news_list">
            ...
            <tbody>
            <c:forEach items="${releaseArticles }" var="article">
            	<tr>
	                ...
	                <td class="optior">
	                  <span title="修改"  articleId="${article.id }"  categoryId="${article.category.id }" class="updateArticle glyphicon glyphicon-edit edit_icon" aria-hidden="true" data-toggle="modal" data-target=".bs-example-modal-edit"></span>
            ...
            <div class="col-sm-11">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-11">
                  ...
                  <input name="videoFile" type="file" id="jobData" onchange="publishVideo(this.files[0])" style="position:absolute;top:0;left:0;font-size:34px; opacity:0" accept=".mp4">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-11">
                   <div class="file-container" style="display:inline-block;position:relative;overflow: hidden;vertical-align:middle">
                  <button class="btn btn-success fileinput-button" type="button">上传视频</button>
                  <input name="videoFile" type="file" id="jobData" onchange="loadFile(this.files[0])" style="position:absolute;top:0;left:0;font-size:34px; opacity:0" accept=".mp4">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
                  ...
                  <input name="musicFile" type="file" id="jobData" onchange="loadmusicFile(this.files[0])" style="position:absolute;top:0;left:0;font-size:34px; opacity:0" accept=".mp3">
              </div>
