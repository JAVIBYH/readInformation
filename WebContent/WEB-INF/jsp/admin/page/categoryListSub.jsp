            ...
            <c:forEach items="${categoryList }" var="category" varStatus="i">
				<tr>
					...
					<td>
						<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target=".bs-example-modal-edit"
						 title="修改" categoryId="${category.id }" description="${category.description }">修改</button>
		                  <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target=".bs-example-modal-del" 
		                  title="删除" categoryId="${category.id }">删除</button>
					</td>
				</tr>
				<c:forEach items="${category.subCategorys }" var="subCategory">
					<tr>
						...
						<td>
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target=".bs-example-modal-edit"
							 title="修改" categoryId="${subCategory.id }" description="${subCategory.description }" parentId="${category.id }">修改</button>
			                  <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target=".bs-example-modal-del" 
